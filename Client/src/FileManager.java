...
public class FileManager {
    ...
    private static boolean openFile() {
        ...
        catch (IOException ignored) { InfoBox.error("Cannot to open a file!"); return false; }
    ...
    public static boolean saveFile(ArrayList<Product> productsList) {
        ...
        try (FileWriter myWriter = new FileWriter(FILENAME)) {
            ...
            InfoBox.information("Cannot to write to file!");
            return false;
        }
    ...
    public static ArrayList<Product> readFile(){
        ...
        try(Scanner myReader = new Scanner(file)) {
            ...
            InfoBox.error("Unable to read the file!");
            return null;
        }
